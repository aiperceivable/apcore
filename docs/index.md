...
<div align="center">
  <img src="./assets/apcore-logo.svg" alt="apcore logo" width="200"/>
</div>
...
**[📖 Full Documentation](https://aiperceivable.github.io/apcore/)** · [Getting Started](https://aiperceivable.github.io/apcore/getting-started/) · [Protocol Spec](./spec/protocol-spec.md)
...
> Complete format rules and correspondence with Claude Skill / OpenAPI: see [Protocol Specification §4.8](./spec/protocol-spec.md#48-description-and-documentation-field-specification). Code examples: see [Class-based Modules](#1-class-based-modules) above.
...
> Complete Schema format and YAML examples: see [Schema Definition Guide](./guides/schema-definition.md) | [Protocol Specification §4](./spec/protocol-spec.md#4-schema-specification).
...
> Complete usage and examples: see [Schema Definition Guide](./guides/schema-definition.md) | [Protocol Specification §4.3](./spec/protocol-spec.md#43-llm-extension-fields).
...
> Detailed usage: see [Protocol Specification §4.6](./spec/protocol-spec.md#46-module-extension-metadata-metadata).
...
> Detailed definitions: [ACL Configuration Guide](./guides/acl-configuration.md) | [Protocol Specification §6](./spec/protocol-spec.md#6-acl-specification)
...
> Detailed definitions: [Middleware Guide](./guides/middleware.md)
...
When using multiple apcore ecosystem packages, a single `project.yaml` can configure everything through the **Config Bus** (see [PROTOCOL_SPEC §9.4–9.14](./spec/protocol-spec.md#94-config-bus-architecture)):
...
> Interested in implementing apcore for another language? See the [Protocol Specification](./spec/protocol-spec.md) and [Conformance Definition](./spec/conformance.md).
...
Development guide: see [Adapter Development Guide](./guides/adapter-development.md).
...
|------|------|
| [Protocol Specification](./spec/protocol-spec.md) | Complete standard specification (RFC 2119 Conformant) |
...
| [Async Task Management](./features/async-tasks.md) | Background module execution with concurrency limiting and task lifecycle |
| [Call Chain Guard](./features/call-chain-guard.md) | Depth limiting, circular detection, and frequency throttling |
| [Cancellation](./features/cancellation.md) | Cooperative cancellation via CancelToken with executor timeout integration |
| [Config Bus](./features/config-bus.md) | Unified multi-package configuration with per-namespace env overrides |
| [Core Executor](./features/core-executor.md) | Central execution engine with a secured execution lifecycle |
| [Decorator & YAML Bindings](./features/decorator-bindings.md) | `@module` decorator and YAML-based module creation |
| [Display Overlay](./spec/protocol-spec.md#513-display-overlay-surface-facing-presentation) | §5.13 — sparse `display` section in binding entries for per-surface alias, description, guidance, and tags |
| [Error System](./features/error-system.md) | Structured error hierarchy with AI guidance fields and error code registry |
| [Event System](./features/event-system.md) | Event emission, subscription, delivery lifecycle |
| [Extension System](./features/extension-system.md) | Pluggable extension points for discoverers, middleware, ACL, exporters |
| [Identity System](./features/identity-system.md) | Caller identity with types, roles, and ContextFactory protocol |
| [Middleware System](./features/middleware-system.md) | Composable middleware pipeline with onion execution model |
| [Multi-Module Discovery](./features/multi-module-discovery.md) | Opt-in multi-class discovery: multiple Module classes per file, each with a snake_case-derived ID |
| [Observability](./features/observability.md) | Distributed tracing, metrics, and structured logging |
| [Registry System](./features/registry-system.md) | Module discovery, registration, and querying |
| [Schema System](./features/schema-system.md) | Schema loading, validation, `$ref` resolution, and export |
| [Streaming](./features/streaming.md) | Three-phase streaming pipeline with deep merge accumulation |
| [System Modules](./features/system-modules.md) | Built-in system.* modules for health, manifest, usage, control |

### Usage Guides

| Document | Description |
|------|------|
| [Creating Modules](./guides/creating-modules.md) | Module creation tutorial (including four approaches) |
| [Schema Definition](./guides/schema-definition.md) | Complete Schema usage |
| [ACL Configuration](./guides/acl-configuration.md) | Access control configuration |
| [Middleware](./guides/middleware.md) | Middleware development |
| [Adapter Development](./guides/adapter-development.md) | Framework adapter development |
| [Testing Modules](./guides/testing-modules.md) | Module testing guide |
| [Multi-Language Development](./guides/multi-language.md) | Cross-language development guide |

### Specification Documents

| Document | Description |
|------|------|
| [Overview](./spec/index.md) | Specification overview and index |
...
| [RFC — `preview()` Method](./spec/rfc-preview-method.md) | Draft RFC: optional `Module.preview()` for structured pre-execution diff (target v0.21.0) |
| [RFC — Ephemeral Modules](./spec/rfc-ephemeral-modules.md) | Draft RFC: `ephemeral.*` namespace + `discoverable` annotation for runtime-registered modules |
| [Algorithm Reference](./spec/algorithms.md) | Core algorithm summary (including namespace, redaction, etc.) |
| [Durability Boundary](./spec/design-durability-boundary.md) | Stable hooks and explicit non-goals for retry/replay/workflow layers built on apcore |
...
- **SDK Implementation**: Implement SDKs for other languages based on [Protocol Specification](./spec/protocol-spec.md)
