...
| [`acl_rule_key_closure`](https://github.com/aiperceivable/apcore/blob/main/conformance/fixtures/acl_rule_key_closure.json) | 8 | ACL rule keys are a closed set; an unknown or reserved key fails the load (spec §6.1) |
