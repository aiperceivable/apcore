...
| [`acl_argument_scoped_approval`](https://github.com/aiperceivable/apcore/blob/main/conformance/fixtures/acl_argument_scoped_approval.json) | 20 | Authorization and approval requirement are two orthogonal results; the built-in `arguments` condition scopes a rule to this call (spec §6.1.6/§6.1.7/§6.1.8) |
