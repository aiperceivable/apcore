...
> Ships `PROTOCOL_SPEC` **v1.37.0 → v1.44.0**. Eight decisions of the same shape, one release.
...
> declared in two places that disagree, with the more complete declaration discarded.
